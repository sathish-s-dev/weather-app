  ...
  */
	...
	return (
		<div className='bg-slate-950 w-full flex justify-center'>
			<footer className='bg-slate-950 text-center text-white w-full'>
				<div className='container py-2 px-6 mx-auto flex justify-center max-w-5xl'>
				...
				{/* <!--Copyright section--> */}
				<div className='px-4 py-2 text-[0.7rem] text-center bg-slate-950 bg-opacity-20 pb-10'>
					© 2023 Copyright:
					<a
